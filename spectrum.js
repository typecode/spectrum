                ...
                "<div class='sp-picker-container'>",
                    "<div class='sp-top sp-cf'>",
                        ...
                        "<div class='sp-top-inner'>",
                            ...
                            "<div class='sp-hue'>",
                                "<div class='sp-slider'>",
                                    '<svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 48">',
                                        '<defs><style>.cls-1{fill:#e4e3ec;}.cls-2{fill:none;stroke:#001aff;stroke-linecap:square;stroke-width:2px;}</style></defs>',
                                        '<rect class="cls-1" width="24" height="48"/>',
                                        '<path id="Line-24" class="cls-2" d="M90,86v24" transform="translate(-80.96 -74.13)"/>',
                                        '<path id="Line-24-Copy" class="cls-2" d="M96,86v24" transform="translate(-80.96 -74.13)"/>',
                                    '</svg>',
                                "</div>",
                                gradientFix,
                            "</div>",
